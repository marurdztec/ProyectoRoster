...
# Si no existe el archivo, crear con encabezados
    ...
    if nomina:
        ...
        if datos_profesor.empty:
            ...
            if st.button("📨 Enviar"):
                ...
                # Opcional: botón para descargar CSV actualizado
                with open(ARCHIVO_RESPUESTAS, "rb") as file:
                    st.download_button(
                        label="⬇️ Descargar registros de confirmaciones",
                        data=file,
                        file_name="confirmaciones_respuestas.csv",
                        mime="text/csv"
                    )